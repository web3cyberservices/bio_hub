...
const GenerateRecommendationsOutputSchema = z.object({
  ...
  mealPlan: z.array(z.object({
    ...
    meals: z.array(z.object({
      ...
      imageUrl: z.string().describe('ОБЯЗАТЕЛЬНОЕ ПОЛЕ. ПОЛНАЯ прямая ссылка на фото Unsplash (https://images.unsplash.com/photo-...).'),
...
3. Подбирайте [ID] из примеров ниже, наиболее подходящий по смыслу:
