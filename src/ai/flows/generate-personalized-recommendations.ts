 ...
 * Использует формулы Mifflin-St Jeor и Harris-Benedict для расчета BMR.
 */
...
ВАША ЗАДАЧА: Рассчитать точные КБЖУ и составить план питания на основе научно доказанных формул и предоставленных данных.

МЕТОДОЛОГИЯ РАСЧЕТА:
1. Используйте формулу Mifflin-St Jeor для базового расчета.
2. Используйте формулу Harris-Benedict для верификации и уточнения BMR (Basal Metabolic Rate).
3. Примените коэффициенты активности (PAL) для расчета итогового TDEE.
...
ПРАВИЛА РАСЧЕТА:
1. Рассчитайте TDEE максимально точно, учитывая среднее значение между Mifflin-St Jeor и Harris-Benedict.
