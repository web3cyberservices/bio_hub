export default function HeroSection() {
  return (
    <div className="max-w-6xl mx-auto px-4 pt-24 pb-16 font-sans text-gray-200">
      ...
      <h1 className="text-4xl md:text-5xl font-black tracking-tight text-white mb-8 uppercase leading-[1.1]">
        Инфраструктурные решения для <br className="hidden md:block" />
        высоконагруженных систем
      </h1>

      <p className="text-lg text-gray-400 max-w-3xl leading-relaxed mb-12 font-medium uppercase tracking-wide text-[13px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/10 border border-white/10">
        <div className="p-10 bg-black">
          ...
          <h3 className="text-lg font-black text-white mb-4 uppercase tracking-tighter">Bare-Metal Infrastructure</h3>
          ...
          <div className="text-[9px] font-mono text-white/30 pt-4 border-t border-white/5 uppercase tracking-widest">
        ...
        <div className="p-10 bg-black">
          ...
          <h3 className="text-lg font-black text-white mb-4 uppercase tracking-tighter">Low-Latency Connectivity</h3>
          <p className="text-gray-400 text-[11px] leading-relaxed mb-8 font-bold uppercase tracking-wider">
        ...
        <div className="p-10 bg-black">
          ...
          <h3 className="text-lg font-black text-white mb-4 uppercase tracking-tighter">Network Isolation</h3>
          <p className="text-gray-400 text-[11px] leading-relaxed mb-8 font-bold uppercase tracking-wider">
      ...
      <section className="mt-32 space-y-12 border-t border-white/10 pt-20">
        <div className="max-w-3xl">
          ...
          <p className="text-gray-400 text-[11px] leading-relaxed font-bold uppercase tracking-widest">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            <div key={loc.region} className="p-6 border border-white/5 bg-white/[0.02]">
              <div className="text-[9px] text-white/40 mb-2 uppercase tracking-widest font-black">{loc.region}</div>
              <div className="text-[10px] text-white font-black mb-4 uppercase">{loc.location}</div>
              <div className="text-[8px] text-emerald-500 font-mono uppercase tracking-[0.2em]">{loc.status}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="mt-32 p-12 bg-white/[0.01] border border-white/10">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div className="space-y-4">
            <h2 className="text-xl font-black uppercase tracking-tighter text-white">СООТВЕТСТВИЕ СТАНДАРТАМ</h2>
            <p className="text-[10px] text-muted-foreground uppercase tracking-widest max-w-2xl font-bold leading-relaxed">
          ...
          <div className="flex gap-4 shrink-0">
            <div className="px-4 py-2 border border-white/10 text-[8px] font-black uppercase tracking-widest text-white/60">ISO 27001 COMPLIANT</div>
            <div className="px-4 py-2 border border-white/10 text-[8px] font-black uppercase tracking-widest text-white/60">SOC 2 TYPE II</div>
          </div>
        </div>
      </section>
    </div>
