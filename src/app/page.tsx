export default function HeroSection() {
  return (
    <div className="h-[calc(100vh-3.5rem)] flex flex-col bg-grid px-4 overflow-hidden relative">
      {/* Hero Section */}
      <div className="flex-1 flex flex-col justify-center max-w-6xl mx-auto w-full">
        <header className="space-y-6 md:space-y-8">
          <div className="space-y-2">
            <div className="inline-block px-3 py-1 bg-blue-500/10 border border-blue-500/20 text-blue-500 text-[8px] md:text-[9px] font-black uppercase tracking-[0.3em] rounded-sm mb-4">
              Infrastructure Platform v2.0
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight text-white leading-[1.1] max-w-4xl">
          ...
          <div className="max-w-2xl">
            <p className="text-[11px] md:text-[13px] text-gray-400 leading-relaxed font-medium tracking-wide">
