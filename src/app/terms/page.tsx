        ...
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="grid gap-8">
            ...
            <section className="p-8 rounded-[2rem] bg-amber-500/5 border border-amber-500/20 space-y-4">
              ...
              <p className="text-white/70 leading-relaxed font-medium">
                Сервис <strong>PRO Себя</strong> использует искусственный интеллект для анализа данных. ИИ-рекомендации не являются постановкой диагноза, не являются врачебным назначением и не заменяют очную консультацию квалифицированного специалиста.
              </p>
            </section>
