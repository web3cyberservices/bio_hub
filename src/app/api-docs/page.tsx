    ...
    <div className="py-12 md:py-24 container mx-auto px-4 md:px-6 max-w-6xl overflow-x-hidden">
      <div className="mb-10 md:mb-16 border-b border-white/5 pb-8 md:pb-12 text-center lg:text-left">
        <div className="flex flex-col lg:flex-row items-center gap-3 md:gap-4 text-primary mb-4 md:mb-6">
          ...
          <h1 className="text-3xl md:text-4xl font-black tracking-tight">Интеграция агентов</h1>
        </div>
        <p className="text-muted-foreground max-w-2xl text-sm md:text-base font-medium mx-auto lg:mx-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
        <div className="lg:col-span-2 space-y-8 md:space-y-12">
          ...
          <section className="bg-blue-600/5 border border-blue-500/20 rounded-xl md:rounded-2xl p-6 md:p-8">
            ...
            <p className="text-[12px] md:text-sm text-slate-400 mb-6 font-medium">
              Автоматический установщик Web3CyberServices Agent для Linux систем (x86_64/ARM64).
            </p>
            <div className="bg-black/50 p-4 rounded-xl font-mono text-[11px] md:text-sm flex items-center justify-between border border-white/10 mb-6 overflow-hidden">
          ...
          <div className="space-y-6 md:space-y-8">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3 bg-slate-900 p-2 rounded-lg border border-white/5">
                <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">API:</span>
                <input 
                  type="text" 
                  value={apiKey} 
                  onChange={(e) => setApiKey(e.target.value)}
                  className="bg-transparent border-none text-[11px] font-mono text-blue-400 w-32 focus:outline-none"
                />
              </div>
            </div>

            {[
              { id: 'vector', name: 'Vector (Datadog Agent)', code: configs.vector },
              { id: 'otel', name: 'OpenTelemetry (OTLP)', code: configs.otel },
              { id: 'fluentd', name: 'Fluentd / Logstash', code: configs.fluentd }
            ].map((cfg) => (
              <div key={cfg.id} className="bg-slate-900/50 border border-white/5 rounded-xl md:rounded-2xl overflow-hidden">
                <div className="px-4 md:px-6 py-3 md:py-4 bg-white/5 flex items-center justify-between border-b border-white/5">
                  ...
                  <button 
                    ...
                    className="text-[10px] md:text-xs font-bold text-slate-500 hover:text-white flex items-center gap-2"
                  >
        ...
        <div className="space-y-6">
          <div className="bg-slate-900/40 border border-white/5 p-6 md:p-8 rounded-xl md:rounded-2xl">
            <h4 className="text-[10px] font-black text-blue-500 uppercase tracking-widest mb-6">Сетевые эндпоинты</h4>
            <div className="space-y-6">
              <div>
          ...
          <div className="bg-blue-600/10 border border-blue-500/20 p-6 rounded-xl md:rounded-2xl">
            <h4 className="text-[10px] font-black text-white uppercase tracking-widest mb-3">SLA & Поддержка</h4>
