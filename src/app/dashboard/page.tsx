  ...
  return (
    <div className="flex h-screen flex-col bg-[#000000] text-white overflow-hidden">
      ...
      <main className="flex-1 relative w-full h-full overflow-hidden">
        {viewingSpecialistId ? (
          <div className="pt-20 md:pt-24 overflow-y-auto h-full px-4 pb-32">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full h-full flex flex-col">
            ...
            <TabsContent value="feed" className="flex-1 min-h-0 m-0 pt-12 md:pt-16 space-y-6 h-full overflow-y-auto px-4 pb-40 no-scrollbar outline-none data-[state=active]:flex flex-col">
               <div className="flex items-center justify-between px-2 w-full max-w-2xl mx-auto mb-2 shrink-0">
            ...
            <TabsContent value="meals" className="flex-1 min-h-0 m-0 pt-12 md:pt-16 overflow-y-auto h-full px-4 pb-40 no-scrollbar outline-none data-[state=active]:block">
               <div className="max-w-4xl mx-auto pb-10">
                  <PersonalMealPlan selectedDate={selectedDate || startOfToday()} />
               </div>
            </TabsContent>

            <TabsContent value="chats" className="flex-1 min-h-0 m-0 pt-12 md:pt-16 h-full px-4 pb-40 outline-none data-[state=active]:flex flex-col">
              <div className="flex-1 min-h-0 max-w-6xl w-full mx-auto pb-10">
                <ChatInterface />
              </div>
            </TabsContent>

            <TabsContent value="feeling" className="flex-1 min-h-0 m-0 pt-12 md:pt-16 overflow-y-auto h-full px-4 pb-40 no-scrollbar outline-none data-[state=active]:block">
              <div className="max-w-4xl mx-auto pb-10">
                <WellBeingStatus deviceData={dailyLogDoc} />
              </div>
            </TabsContent>

            <TabsContent value="profile" className="flex-1 min-h-0 m-0 pt-12 md:pt-16 overflow-y-auto h-full px-4 pb-40 no-scrollbar outline-none data-[state=active]:block">
