    ...
    <div className="min-h-screen bg-black text-white py-20 px-4 md:px-6 bg-grid">
      <div className="container mx-auto max-w-6xl">
        <div className="mb-16 border-b border-white/10 pb-12">
          ...
          <h1 className="text-3xl md:text-5xl font-black tracking-tighter mb-6">Правовые документы и комплаенс</h1>
          <p className="text-[11px] text-muted-foreground font-bold tracking-[0.2em] max-w-2xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <aside className="lg:col-span-3">
            <nav className="space-y-1 sticky top-28">
              {sections.map((section) => (
                <button
                  ...
                  className={`w-full flex items-center justify-between px-4 py-3 text-[10px] font-black tracking-widest transition-all border ${
            ...
            <div className="mt-12 p-6 border border-white/5 bg-white/[0.02]">
              <div className="flex items-center gap-2 text-blue-500 mb-4 text-[9px] font-black tracking-widest">
                <Info className="w-3.5 h-3.5" /> Юридические реквизиты
              </div>
              <div className="text-[9px] text-muted-foreground leading-relaxed font-bold space-y-2">
          ...
          <main className="lg:col-span-9 space-y-8 pb-32">
            ...
            {activeTab === 'offer' && (
              <section className="prose prose-invert max-w-none">
                <h2 className="text-xl font-black tracking-widest mb-8 pb-4 border-b border-white/10">Публичная оферта на оказание услуг IaaS</h2>
                <div className="text-[11px] leading-relaxed space-y-6 font-medium text-gray-300 tracking-wide">
            ...
            {activeTab === 'privacy' && (
              <section className="prose prose-invert max-w-none">
                <h2 className="text-xl font-black tracking-widest mb-8 pb-4 border-b border-white/10">Политика обработки персональных данных (152-ФЗ)</h2>
                <div className="text-[11px] leading-relaxed space-y-6 font-medium text-gray-300 tracking-wide">
                  <p>
            ...
            {activeTab === 'aml' && (
              <section className="prose prose-invert max-w-none">
                <h2 className="text-xl font-black tracking-widest mb-8 pb-4 border-b border-white/10">AML/KYC Политика и мониторинг (115-ФЗ)</h2>
                <div className="text-[11px] leading-relaxed space-y-6 font-medium text-gray-300 tracking-wide">
