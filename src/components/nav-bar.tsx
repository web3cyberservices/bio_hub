  ...
  return (
    <nav className="sticky top-0 z-[100] w-full bg-primary/90 backdrop-blur-xl border-b border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.1)]">
      <div className="container mx-auto flex h-20 items-center justify-between px-4 md:px-8">
        {/* Логотип: скрыт на мобильных устройствах (до md) */}
        ...
        {/* Навигационные ссылки: скрыты на мобильных (до lg) */}
        ...
        {/* Кнопки авторизации: на мобильных занимают все пространство и центрируются */}
        <div className="flex items-center gap-4 w-full justify-center md:w-auto md:justify-end">
          <Link href="/login">
            <Button variant="ghost" className="h-12 font-black text-[10px] uppercase tracking-widest text-white hover:bg-white/10 px-4 md:px-6">Войти</Button>
          </Link>
          <Link href="/register">
