        ...
        <div className="flex items-center gap-4 md:gap-6">
           {isGuest ? (
             <div className="flex items-center gap-2 md:gap-4">
                <Button asChild variant="ghost" className="rounded-xl font-black uppercase tracking-widest text-[10px] h-10 px-4 hidden sm:flex">
                  <Link href="/login" className="flex items-center gap-2">
                    <LogIn className="h-4 w-4" /> Войти
                  </Link>
                </Button>
                <Button asChild className="rounded-xl font-black uppercase tracking-widest text-[10px] h-10 px-6 bg-primary shadow-lg shadow-primary/20">
             ...
             <Link href="/dashboard" className="hidden md:flex items-center gap-3 bg-primary/5 px-5 py-2.5 rounded-2xl border border-primary/10 hover:bg-primary/10 transition-colors">
