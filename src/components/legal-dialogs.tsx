...
Сервис Bio Hub Pro использует искусственный интеллект для анализа данных. ИИ-рекомендации не являются постановкой диагноза и не заменяют очную консультацию врача.
        ...
        <ScrollArea className="h-[50vh] p-8 bg-blue-950/40 backdrop-blur-3xl">
          ...
          <div className="mt-8 p-6 rounded-2xl bg-primary/5 border border-primary/20 flex items-start gap-4">
             ...
             <p className="text-[10px] font-bold text-white/50 uppercase leading-relaxed tracking-wider">
               Используя сервис Bio Hub Pro, вы автоматически подтверждаете ознакомление с данными документами.
             </p>
          </div>
        </ScrollArea>
      </DialogContent>
