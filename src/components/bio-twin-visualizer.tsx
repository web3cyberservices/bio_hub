      ...
      <div className="relative z-[60] w-full h-full flex items-center justify-between px-4 md:px-20 pointer-events-none">
        ...
        <div className="flex flex-col gap-4 md:gap-8 items-start justify-center h-full pointer-events-auto">
          ...
          <NeonGauge 
            ...
            icon={<Moon className="h-4 w-4 md:h-7 md:w-7 text-[#818CF8]" />} color="#818CF8" 
            progress={getProgress(sleepVal, 8)}
          />
          <NeonGauge 
            label="ПУЛЬС" value={hrVal}
            icon={<Heart className="h-4 w-4 md:h-7 md:w-7 text-[#FB7185]" />} color="#FB7185" 
            progress={getProgress(hrVal, 100)}
          />
          <NeonGauge 
            label="АД" value={bpVal}
            icon={<Activity className="h-4 w-4 md:h-7 md:w-7 text-[#F472B6]" />} color="#F472B6" 
            progress={100}
          />
        </div>
        ...
        <div className="flex flex-col gap-4 md:gap-8 items-end justify-center h-full pointer-events-auto">
          ...
          <NeonGauge 
            ...
            icon={<Beef className="h-4 w-4 md:h-7 md:w-7 text-[#F87171]" />} color="#F87171" 
            progress={getProgress(proteinVal, 150)}
          />
          <NeonGauge 
            label="ЖИРЫ" value={`${fatVal}г`}
            icon={<Droplet className="h-4 w-4 md:h-7 md:w-7 text-[#FACC15]" />} color="#FACC15" 
            progress={getProgress(fatVal, 80)}
          />
          <NeonGauge 
            label="УГЛЕВ" value={`${carbVal}г`}
            icon={<Zap className="h-4 w-4 md:h-7 md:w-7 text-[#4ADE80]" />} color="#4ADE80" 
