...
export function BioTwinVisualizer({ score, deviceData, macros, className }: any) {
  ...
  return (
    <div className={cn("relative w-full h-full flex items-center justify-center overflow-hidden bg-[#000000] touch-none", className)}>
      ...
      <div className="absolute top-[48%] md:top-[36%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-[70] pointer-events-none">
      ...
      <div className="absolute inset-0 z-50 pointer-events-none flex items-center justify-center overflow-hidden">
        <div className="relative w-[450vw] h-[180vh] md:w-full md:h-[68vh] max-w-none md:max-w-6xl animate-hologram flex items-center justify-center transition-all duration-700 -translate-y-8 md:-translate-y-32">
          <Image 
