...
export function BioTwinVisualizer({ score, deviceData, macros, className }: any) {
  ...
  return (
    <div className={cn("relative w-full h-full flex items-center justify-center overflow-hidden bg-[#000000]", className)}>
      ...
      {/* HUD OVERLAY LAYER (Gauges) - Middle Layer */}
      ...
      {/* CENTRAL PULSE (Heart Core) - Top Layer below Image */}
      <div className="absolute top-[42%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-45 pointer-events-none">
      ...
      {/* MAIN HOLOGRAM IMAGE - THE TOP LAYER */}
      ...
      {/* SCAN LINES & GRID OVERLAY - Decorative Background */}
